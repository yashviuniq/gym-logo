-- Align finance insights with /finance month-to-date behavior for the current month
-- and return renewal event timestamps for correct weekly/day drill-downs.
