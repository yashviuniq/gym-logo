...
export async function POST(request) {
  try {
    const { p_gym_id, p_period_start, p_period_end, p_user_id } = await request.json();
    ...
    console.log("[TenantCheck][finance/data] userId:", p_user_id, "user.gym_id:", userGymId, "requestedGymId:", p_gym_id || null, "finalGymId:", finalGymId);
